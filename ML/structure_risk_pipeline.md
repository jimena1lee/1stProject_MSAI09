...
| 검증 방식 | AUC 평균 |
|---|---|
| Stratified K-Fold | 0.3942 |
| Group K-Fold | 0.3942 |

→ AUC 0.39 — **가설 반박.**  
전국 범위에서는 구조 위험과 사고가 양의 관계이지만,  
성남시로 좁히면 음의 관계가 나타납니다.

**원인 가설:** 구조적으로 위험한 곳일수록 CCTV, 과속방지턱, 보행자 보호시설이 집중 설치되어 실제 사고 확률을 낮추는 **역설적 패턴** 존재.

**→ 다음 단계:** 시설 변수(CCTV 수, 과속방지턱 유무 등)를 추가 피처로 투입하여 모델 보완 필요.
